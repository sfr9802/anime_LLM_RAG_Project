...
from app.application.services.retrieval_common import retrieve as svc_retrieve
from app.application.services.eval_service import evaluate_hit as svc_evaluate_hit
from app.application.services.rag_backend import get_rag_service
...
async def ping_llm():
    ...
    used_model = config.llm_model_alias
...
@router.get("/count")
def debug_count():
    from app.infrastructure.vector.chroma_store import get_collection
