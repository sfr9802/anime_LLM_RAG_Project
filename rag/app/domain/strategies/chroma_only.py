...
from app.infrastructure.vector.adapters import flatten_chroma_result
from app.infrastructure.vector.chroma_store import search as chroma_search

from app.application.services.utils import _cap_by_title, _env_int, _env_ints, _expand_queries
from app.application.services.fusion import _attach_embeddings, _rrf_merge
from app.domain.mmr import _mmr
from app.domain.strategies.base import RetrievalStrategy

try:
    # 선택: BM25 스파스 검색기 (없으면 None)
    from app.domain.bm25 import bm25_search  # (query, n, where) -> flatten_chroma_like list
except Exception:
    bm25_search = None
