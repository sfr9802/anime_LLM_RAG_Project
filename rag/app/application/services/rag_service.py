...
from app.infrastructure.llm.provider import get_chat
from app.infrastructure.vector.metrics import to_similarity
from app.api.schemas.responses import DocumentItem, RAGQueryResponse

from app.application.services.utils import _env_float
from app.application.services.expand import _expand_same_doc, _quota_by_section
from app.application.services.retrieval_service import retrieve_docs as _retrieve_docs
from app.application.services.parser import QueryParser
from app.application.services import metrics as rag_metrics
...
class RagService:
    ...
    def _render_prompt(self, question: str, context: str) -> str:
        from app.prompt.loader import render_template
